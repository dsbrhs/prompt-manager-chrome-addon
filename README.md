...
- サイドパネルでプロンプトを管理
- フォルダツリービューで階層構造を表示
- プロンプト一覧を表示し、クリックで ChatGPT の入力欄へ自動挿入

### ✔️ 分類・整理機能

- **カテゴリ分類**: プロンプトをカテゴリで分類
- **タグ機能**: 複数のタグを設定してプロンプトを整理
- **フォルダ階層構造**: フォルダを作成してプロンプトを階層的に管理
  - フォルダの作成・編集・削除
  - 親フォルダを指定した階層構造
  - フォルダ内のプロンプト数を表示
